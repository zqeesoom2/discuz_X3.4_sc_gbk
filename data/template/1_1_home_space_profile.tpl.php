...
0
|| checktplrefresh('./template/default/home/space_profile.htm', './template/default/home/space_header.htm', 1608089114, '1', './data/template/1_1_home_space_profile.tpl.php', './template/default', 'home/space_profile')
|| checktplrefresh('./template/default/home/space_profile.htm', './template/default/home/space_profile_body.htm', 1608089114, '1', './data/template/1_1_home_space_profile.tpl.php', './template/default', 'home/space_profile')
|| checktplrefresh('./template/default/home/space_profile.htm', './template/default/home/space_userabout.htm', 1608089114, '1', './data/template/1_1_home_space_profile.tpl.php', './template/default', 'home/space_profile')
|| checktplrefresh('./template/default/home/space_profile.htm', './template/default/common/header_common.htm', 1608089114, '1', './data/template/1_1_home_space_profile.tpl.php', './template/default', 'home/space_profile')
|| checktplrefresh('./template/default/home/space_profile.htm', './template/default/home/space_diy.htm', 1608089114, '1', './data/template/1_1_home_space_profile.tpl.php', './template/default', 'home/space_profile')
|| checktplrefresh('./template/default/home/space_profile.htm', './template/default/home/space_header_personalnv.htm', 1608089114, '1', './data/template/1_1_home_space_profile.tpl.php', './template/default', 'home/space_profile')
;?>
...
<?php echo '<hook>[string space_profile_baseinfo_top]</hook>';if(!empty($_G['setting']['pluginhooks']['space_profile_baseinfo_top'])) echo $_G['setting']['pluginhooks']['space_profile_baseinfo_top'];?>
<?php } elseif(CURMODULE == 'follow') { ?>
<?php echo '<hook>[string follow_profile_baseinfo_top]</hook>';if(!empty($_G['setting']['pluginhooks']['follow_profile_baseinfo_top'])) echo $_G['setting']['pluginhooks']['follow_profile_baseinfo_top'];?>
<?php } ?>
...
<?php if(CURMODULE == 'space') { ?>
<?php echo '<hook>[string space_profile_baseinfo_middle]</hook>';if(!empty($_G['setting']['pluginhooks']['space_profile_baseinfo_middle'])) echo $_G['setting']['pluginhooks']['space_profile_baseinfo_middle'];?>
<?php } elseif(CURMODULE == 'follow') { ?>
<?php echo '<hook>[string follow_profile_baseinfo_middle]</hook>';if(!empty($_G['setting']['pluginhooks']['follow_profile_baseinfo_middle'])) echo $_G['setting']['pluginhooks']['follow_profile_baseinfo_middle'];?>
<?php } ?>
...
<?php if(CURMODULE == 'space') { ?>
<?php echo '<hook>[string space_profile_baseinfo_bottom]</hook>';if(!empty($_G['setting']['pluginhooks']['space_profile_baseinfo_bottom'])) echo $_G['setting']['pluginhooks']['space_profile_baseinfo_bottom'];?>
<?php } elseif(CURMODULE == 'follow') { ?>
<?php echo '<hook>[string follow_profile_baseinfo_bottom]</hook>';if(!empty($_G['setting']['pluginhooks']['follow_profile_baseinfo_bottom'])) echo $_G['setting']['pluginhooks']['follow_profile_baseinfo_bottom'];?>
<?php } if($space['medals']) { ?>
<div class="pbm mbm bbda cl">
<h2 class="mbn">勋章</h2>
<p class="md_ctrl">
...
<?php } if(CURMODULE == 'space') { ?>
<?php echo '<hook>[string space_profile_extrainfo]</hook>';if(!empty($_G['setting']['pluginhooks']['space_profile_extrainfo'])) echo $_G['setting']['pluginhooks']['space_profile_extrainfo'];?>
<?php } elseif(CURMODULE == 'follow') { ?>
<?php echo '<hook>[string follow_profile_extrainfo]</hook>';if(!empty($_G['setting']['pluginhooks']['follow_profile_extrainfo'])) echo $_G['setting']['pluginhooks']['follow_profile_extrainfo'];?>
<?php } ?>
