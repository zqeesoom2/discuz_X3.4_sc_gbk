...
0
|| checktplrefresh('./template/default/home/space_menu.htm', './template/default/home/follow_user_header.htm', 1608089114, '1', './data/template/1_1_home_space_menu.tpl.php', './template/default', 'home/space_menu')
;?>
<?php if($space['uid']) { ?>
<div id="uhd">
...
<?php echo '<hook>[string space_menu_extra]</hook>';if(!empty($_G['setting']['pluginhooks']['space_menu_extra'])) echo $_G['setting']['pluginhooks']['space_menu_extra'];?>
