...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1608018977, '1', './data/template/1_1_common_header_plugin_violation.tpl.php', './template/default', 'common/header_plugin_violation')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1608018977, '1', './data/template/1_1_common_header_plugin_violation.tpl.php', './template/default', 'common/header_plugin_violation')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1608018977, '1', './data/template/1_1_common_header_plugin_violation.tpl.php', './template/default', 'common/header_plugin_violation')
;?>
