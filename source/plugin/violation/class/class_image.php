...
class aljbd_image {
	...
	function Watermark($source, $target = '', $type = 'forum',$kindeditor) {
		...
		$route = $kindeditor ? '../../../../../../static/image/common/' : './static/image/common/';
		
		$this->param['watermarkfile'][$type] = $route.($this->param['watermarktype'][$type] == 'png' ? 'watermark.png' : 'watermark.gif');
