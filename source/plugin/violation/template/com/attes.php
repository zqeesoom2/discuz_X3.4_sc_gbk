...
if($_GET['form']=='shenfen'){
	if (submitcheck('formhash')) {
		$rz2=C::t('#violation#aljesc_attestation')->fetch_uid_type_sign($_G['uid'],'2',0);
		if($rz2){
			C::t('#violation#aljesc_attestation')->delete($rz2['id']);
		}
		$insertarray = array(
			'type' => '1',
		...
		if(C::t('#violation#aljesc_attestation')->fetch_uid_type($_G['uid'],'1')){
			$insertarray['sign'] = 0;
			...
			C::t('#violation#aljesc_attestation')->insert($insertarray);
		}
		//showmsg('&#25552;&#20132;&#25104;&#21151;&#65292;&#35831;&#31561;&#24453;&#23457;&#26680;&#65281;');
        showmsg('提交成功，请等待审核！');
	}
	...
	if (submitcheck('formhash')) {
		$rz1=C::t('#violation#aljesc_attestation')->fetch_uid_type_sign($_G['uid'],'1',0);
		if($rz1){
			C::t('#violation#aljesc_attestation')->delete($rz1['id']);
		}
		$insertarray = array(
			'type' => '2',
			'username' => $_G['username'],
		...
		if(C::t('#violation#aljesc_attestation')->fetch_uid_type($_G['uid'],'2')){
			$insertarray['sign'] = 0;
	...
	include template('violation:attestation');
}
?>