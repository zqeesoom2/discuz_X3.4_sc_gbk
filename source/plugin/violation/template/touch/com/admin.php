...
$paging = helper_page :: multi($num, $perpage, $currpage, 'plugin.php?id=aljesc&act=adminlp&search='.$_GET['search'], 0, 11, false, false);
$users = C::t('#aljesc#aljesc_user')->range();
...
include template('aljesc:adminlp');
?>